    ...
    <section id="createBrand_dashboard">
      ...
      <p id="brand_hr"></p>
             ...
             <?php
                include('connect.php');
                 ...
                 if(isset($_GET['page']) && !empty($_GET['page'])){
                  ...
                  $total = mysqli_query($con, "SELECT * FROM brand");
                 ...
                 $sql = mysqli_query($con, "SELECT * FROM brand LIMIT $offset, $item_per_page ");
                            ...
                            for($i=1; $i <= $totalpages; $i++) { 
                              ...
                              if($i === $page){
                                  echo '<li class="active"><a>'. $i . '</a></li>';
                                    ...
                                    echo '<li><a href="manage_brands.php?page=' .$i . '">'.$i.'</a></li>';
             ...
             <div class="panel panel-default" id="manBrands_panel">
                <div class="panel-heading" id="panelH_brand">LISTED BRANDS</div>
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <?php
                       while($row=mysqli_fetch_assoc($sql)){
                        ...
                        $dateu=$row['date_updated'];
                          echo '<tbody>';

                          echo '<td>'.$name.'</td>';
                          echo '<td>'.$datec.'</td>';
                          echo '<td>'.$dateu.'</td>';
                          echo "<td><a href=update_brand.php?id=".$id."><span class='fa fa-pencil-square-o' id='update'></span></a></td>";

                          echo "<td><a href=delete_brand.php?id=".$id."><span class='fa fa-trash' id='trash'></span></a></td></tbody>";
                      } ?>
