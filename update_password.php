...
$email=$_SESSION['email'];
  $cu=$_POST['current_pass'];
  $n=$_POST['new_pass'];
  $c=$_POST['confirm_pass']; 

  $r=mysqli_query($con,"SELECT * FROM clients WHERE email='$email' ");
  if(mysqli_num_rows($r)>0){

  if($n==$c){
$up=mysqli_query($con,"UPDATE clients SET password='$n' WHERE email='$email' ");
if($up){
  ?>
  <script>
var x=window.onbeforeunload;
// logic to make the confirm and alert boxes
if (confirm("password updated successfully") == true) {
...
var x=window.onbeforeunload;
// logic to make the confirm and alert boxes
if (confirm("password mismatch. Please try again") == true) {
    window.location.href = "update_password.php";
}
else{
  window.location.href = "update_password.php";
...
var x=window.onbeforeunload;
// logic to make the confirm and alert boxes
if (confirm("Incorrect Current Password") == true) {
    window.location.href = "update_password.php";
}
else{
  window.location.href = "update_password.php";
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <div class="col-sm-9" id="col_sm">
                <h4 id="general_settings">UPDATE PASSWORD</h4>
                <br>
                <form method="post">

                  <div class="form-group" id="div_form">
                    <label>Current Password</label>
                    <input type="password" name="current_pass" class="form-control" id="form_c">
                  </div>

                  <div class="form-group" id="div_form">
                    <label>New Password</label>
                    <input type="password" name="new_pass" class="form-control" id="form_c">
                  </div>

                  <div class="form-group" id="div_form">
                    <label>Confirm Password</label>
                    <input type="password" name="confirm_pass" class="form-control" id="form_c">
                  </div>

                  <div class="form-group">
                    <button type="submit" name="submit" id="save_pass" class="btn btn-default">Update Password <span class="fa fa-angle-right" id="fa_angle"></span></button>
                  </div>
                </form>
              </div>
