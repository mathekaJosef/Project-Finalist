...
if(isset($_POST['submit'])){
  $mng_page=$_POST['mng_page'];
include('connect.php');
  $rt=mysqli_query($con,"UPDATE about SET words='$mng_page' ");
...
if (confirm("Page updated successfully") == true) {
                ...
                <div class="panel-body">
                  ...
                  <form method="post">
                    <div class="form-group">
                      ...
                      <select name="page" class="form-control" id="sel_page" onChange="getData(this.value)">
