...
if(isset($_POST['submit'])){
  ...
  $up=mysqli_query($con,"UPDATE clients SET address='$address', dob='$dob',city='$city',country='$country', date_registered='$date_registered' WHERE email='$email' ");
if($up){
   ?>
  <script> 
              ...
              <div class="col-sm-9" id="col_sm">
                ...
                <form method="post">
                  ...
                  <div class="form-group" id="div_form">
                    ...
                    <input type="text" name="full_name" class="form-control" id="form_c" value="<?php echo $name; ?>">
                  </div>

                  <div class="form-group" id="div_form">
                    <label>Email Address</label>
                    <input type="email" name="user_email" class="form-control" id="form_c" value="<?php echo $email; ?>">
                  </div>

                  <div class="form-group" id="div_form">
                    <label>Phone Number</label>
                    <input type="number" name="user_num" class="form-control" id="form_c" value="<?php echo $phone; ?>">
                  </div>
                  </fieldset>
                  <div class="form-group" id="div_form">
                    <label>Date of Birth</label>
                    <input type="date" name="dob" class="form-control" id="form_c">
                  </div>

                  <div class="form-group" id="div_form">
                    <label>Your Address</label>
                    <textarea name="address" rows="4" class="form-control" id="form_c" placeholder="<?php echo $address; ?>"></textarea>
                  </div>

                  <div class="form-group" id="div_form">
                    <label>Country</label>
                    <input type="country" name="country" class="form-control" id="form_c" placeholder="<?php echo $country; ?>">
                  </div>

                  <div class="form-group" id="div_form">
                    <label>City</label>
                    <input type="text" name="city" class="form-control" id="form_c" placeholder="<?php echo $city; ?>">
                  </div>

                  <div class="form-group">
                    <button type="submit" name="submit" id="save_c" class="btn btn-default">Save Changes <span class="fa fa-angle-right" id="fa_angle"></span></button>
                  </div>
                </form>
              </div>
