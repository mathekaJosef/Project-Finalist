  ...
  <!-- navbar -->
   ...
   <header class="header">
    ...
    <section id="createBrand_dashboard">
      <p id="brand_p">Manage Contact Us Queries</p>
      <p id="brand_hr"></p>
              ...
              <?php
                include('connect.php');
                 ...
                 if(isset($_GET['page']) && !empty($_GET['page'])){
                  ...
                  $total = mysqli_query($con, "SELECT * FROM query");
                 ...
                 $sql = mysqli_query($con, "SELECT * FROM query LIMIT $offset, $item_per_page ");
                            ...
                            for($i=1; $i <= $totalpages; $i++) { 
                              ...
                              if($i === $page){
                                  echo '<li class="active"><a>'. $i . '</a></li>';
                                    ...
                                    echo '<li><a href="manage_queries.php?page=' .$i . '">'.$i.'</a></li>';
             ...
             <div class="panel panel-default" id="manBrands_panel">
                <div class="panel-heading" id="panelH_brand">USER QUERIES</div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <?php while($row = mysqli_fetch_assoc($sql)){ 
                      ...
                      <tbody>
                        ...
                        <?php
                        echo "<td><a href=deleteq.php?id=".$id."><span class='fa fa-trash' id='trash'></span></a></td>"; ?>
                      </tbody>
                    <?php } ?>
                  </table>
