...
<style type="text/css"> 
   #select_nav1{
        ...
        #car_analysis1{
          ...
          background-color: #fff;
          padding: 8px;
          border-left: 4px solid #fc0363;
          border-bottom: 0.1px solid #ffe5ee;
          animation: moveDown 1s ease-in;
        }
        @keyframes moveDown {
          0%{
...
$query = mysqli_query($con, "SELECT * FROM vehicle WHERE brand = '$select_brand' AND fuel = '$select_fuel'");
...
?>
            ...
            <div class="col-sm-9">
              ...
              if($count === 1){ ?>
                <div id="car_analysis">
                  <h5><?php echo $count;?> Listing found!</h5>
                </div>
              <?php
              } else if(count([$count]) > 1){?>
                <div class="car_analysis">
                  <h5><?php echo $count;?> Listings found!</h5>
                </div>
              <?php
              }else if($count === 0){?>
                <div id="car_analysis1">
                  <h5><?php echo $count;?> Listings found!, check you search again or search for something else.</h5>
                </div>
              <?php
              }
              ?>
